 ...
 * Version 2.21
 *
 * source: https://code.google.com/p/php-excel-reader/issues/detail?id=100
 *
...
{
		$out = "<tableColSheetValue class=\"$table_class\" cellspacing=0>";
		if ($endcol == 0 ){
